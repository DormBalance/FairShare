...
// Returns the expense categories in a given household
// If expense_category_id is provided, returns the name of that category (used for displaying category name in expense details)
export async function GET(request: NextRequest) {
    ...
    console.log('Received GET request for expense categories with household_id:', householdId, 'and expense_category_id:', expenseCategoryId);
    try{
